...
class Stopwords
{
    ...
    public static $countryLanguages = [
        "GB" => ["English"],
        "US" => ["English"],
    ];
     ...
     *
     */
    public static function get($language = 'English', $requestedField = 'stopwords')
    {
        ...
        if (!in_array($requestedField, $supportedFields)) {
            $requestedField = 'stopwords'; //return stopwords if invalid/unsupported field name is request
        }
